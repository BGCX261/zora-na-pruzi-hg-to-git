...
'''
    vrátilo_sa = příkaz()
    assert " ".join(má_být.split()) == " ".join(vrátilo_sa.split())
...
def test_0011_INSERT_ ():
    with py.test.raises(ValueError):
        str(INSERT(tabulka).VALUES(sloupec1 = 25,  sloupec2 = 'řetězec').VALUES( 45,  'řetězec dva'))


def test_0012_INSERT_ ():
    def příkaz():
...
def test_0014_INSERT_ ():
    with py.test.raises(ValueError):
       str(INSERT(tabulka).VALUES(sloupec1 = 25,  sloupec2 = 'řetězec').VALUES(sloupec2 = 'řetězec dva'))


def test_0015_INSERT_ ():
    with py.test.raises(ValueError):
        str(INSERT(tabulka).INTO(tabulka.sloupec1,  'sloupec2').VALUES(sloupec1 = 25,  sloupec100 = 'řetězec'))
    


def test_0016_INSERT_ ():
    with py.test.raises(ValueError):
        str(INSERT(tabulka).INTO(tabulka.sloupec1,  'sloupec2').VALUES(25, 'řetězec').VALUES(11,  'druhý',  'přebývající'))

def test_0017_INSERT_ ():
    with py.test.raises(ValueError):
        str(INSERT(tabulka).VALUES(sloupec2 = 'řetězec',  sloupec1 = 25).VALUES(12,  'dva').VALUES('tři',  3))


def test_0018_INSERT_ ():
    with py.test.raises(ValueError):
        str(INSERT(tabulka).VALUES(sloupec1 = 25,  sloupec2 = 'řetězec').VALUES(12,  'dva').VALUES('tři',  3))

def test_0019_INSERT_ ():
    def příkaz():
...
def test_0020_UPDATE_ ():
    with py.test.raises(ValueError):
        str(UPDATE(tabulka))

def test_0021_UPDATE_ ():
    def příkaz():
...
def test_0026_UPDATE_ ():
    def příkaz():
        return str(UPDATE(tabulka).SET(sloupec1 = 25,  sloupec2 = 'gora').WHERE(tabulka.sloupec == 'gora'))
    má_být = '''
UPDATE
"první_tabulka"
SET
"sloupec1"=25,"sloupec2"='gora'
WHERE
"první_tabulka"."sloupec"='gora'
'''
    vrátilo_sa = příkaz()
    assert " ".join(má_být.split()) == " ".join(vrátilo_sa.split())


def test_0027_UPDATE_ ():
    def příkaz():
